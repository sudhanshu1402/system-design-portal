...
Replaces monolithic API calls with composable, functional Data pipelines (`RunnableSequence`). The data flows from the `PromptTemplate`, explicitly piped into the Language Model, and then immediately piped into a parser.
